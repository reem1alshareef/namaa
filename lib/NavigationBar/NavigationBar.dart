  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: currentPageIndex != 2 // 2 corresponds to the index of viewChat() in the list
                        ...
                        items: [
                          BottomNavigationBarItem(
                            icon: new Image.asset(
                              ...
                              fit: BoxFit.fill,
                              width: returnImageIconSize(),
                              height: returnImageIconSize(),
                            ),
                            activeIcon: Container(
                              padding: EdgeInsets.all(8),
                              margin: EdgeInsets.only(left: 7),
                          ...
                          BottomNavigationBarItem(
                            icon: new Image.asset(
                              'assets/NavBarIcons/SavingPlan.png',
                              fit: BoxFit.fill,
                              width: returnImageIconSize(),
                              height: returnImageIconSize(),
                            ),
                          ...
                          BottomNavigationBarItem(
                            icon: new Image.asset(
                              'assets/NavBarIcons/Chatbot.png',
                              fit: BoxFit.fill,
                              width: returnImageIconSize(),
                              height: returnImageIconSize(),
                            ),
          ...
          : null, // Set bottomNavigationBar to null if currentPageIndex is 2 (viewChat())
      body: <Widget>[
        Container(
          padding: EdgeInsets.only(top: 50.0, left: 10, right: 10),
          width: 428,
