...
class ViewModelViewExpenses extends BaseViewModel {
  ...
  final currentUser = supabase.auth.currentUser;
   ...
   // print('objecttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt');

    final response = await supabaseClient.from('expenses').select().eq('emailAddress', getCurrentUserEmail()).execute();
